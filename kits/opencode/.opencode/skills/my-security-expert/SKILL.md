...
## Definition of Done
- [ ] Hallazgos priorizados con un cambio concreto cada uno.
- [ ] Sin secretos reimpresos ni exploits.
- [ ] JWT/OAuth derivado a `security-jwt-expert` si aplica.

## Errores comunes
- Pedir un pentest ofensivo.
- Marcar todo como crítico.
- Olvidar autorización a nivel de recurso (IDOR).
