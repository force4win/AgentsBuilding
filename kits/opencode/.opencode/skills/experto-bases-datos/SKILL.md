...
## Definition of Done
- [ ] Access patterns y ratio lectura/escritura considerados.
- [ ] DDL o documento JSON de ejemplo, no solo prosa.
- [ ] Migraciones destructivas alineadas con `sql-migration-safety`.

## Errores comunes
- NoSQL «porque sí» en dominio transaccional.
- Desnormalizar de entrada por pereza.
- `DELETE`/`DROP` en el mismo diseño sin plan de rollback.
