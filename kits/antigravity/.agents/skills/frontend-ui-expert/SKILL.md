...
## Definition of Done
- [ ] Componente usable con teclado y label visible.
- [ ] Fetch con la librería que ya usa el repo (no mezclar Query y useEffect).
- [ ] Estados vacío / carga / error cubiertos.

## Errores comunes
- Inventar un design system distinto al del repo.
- Tablas no usables en móvil (delegar a `experto-ux-mobile`).
- Poner secretos de API en el bundle.
